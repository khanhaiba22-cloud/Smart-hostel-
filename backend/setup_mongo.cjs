...
async function seed() {
  ...
  console.log('✅ Admin & Warden created');
  ...
  await Notice.insertMany([
    ...
    { title:'Food Menu Update', description:'New mess menu from Monday. Breakfast at 7:30 AM.', type:'Food Menu', postedBy:'Riya Jain' },
    { title:'Water Supply Shutdown', description:'Water off Sunday 10 AM–2 PM for maintenance.', type:'Maintenance', postedBy:'Ambar Jain' },
  ]);
